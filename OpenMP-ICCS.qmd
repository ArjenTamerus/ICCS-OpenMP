...
## Why go parallel
![CPU](images/cpu.1.png){height=70%}


## Why go parallel
![CPU](images/cpu.2.png){height=70%}


## Why go parallel
![CPU](images/cpu.3.png){height=70%}


## Why go parallel
![CPU](images/cpu.drawio.png){height=70%}
...
::::
:::: column
![architecture](images/node.cut.png)
::::
:::
